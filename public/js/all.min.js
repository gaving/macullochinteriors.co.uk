...
$(document).ready(function(){function o(){$(window).width()>768&&$(".parallax").each(function(){var o=$(this).offset().top+$(this).height(),i=$(this).offset().top,n=$(window).height(),s=$(window).scrollTop()+n,e=0,l=!0;if(0===i?(e=$(window).scrollTop()-i,l=!0):(e=$(window).scrollTop()-i+n,l=!1),o>$(window).scrollTop()&&s>i){var a=-1*(e/3),r=a,c=1-1.3*($(window).scrollTop()/$(window).height());l&&(r+=t,$("#home .logo").css("marginTop",a+"px"),$("#home .logo, #home .welcome, #home .call-to-action, #home .macbook-preview").css("opacity",c)),$(this).children("img").first().css("bottom",r+"px")}})}function i(){{var o=new google.maps.LatLng(55.8750993,-4.3976475),i={center:o,scrollwheel:!1,zoom:13},t=new google.maps.Map(document.getElementById("map-canvas"),i);new google.maps.Marker({position:o,map:t})}}var t=80;$(window).scroll(function(){var o=$(window).scrollTop();$(".slide-in").each(function(){var i=$(this).offset().top,t=$(this).height();o>i-1.5*t&&!$(this).hasClass("slid")&&$(this).addClass("slid")}),$("body").scrollspy({offset:t+10,target:"#navbar"})}),$(".carousel").carousel({pause:!1,interval:8e3}),$("#navbar").affix({offset:{top:function(){return this.top=$(window).height()-t}}}),o(),$(window).scroll(function(){o()}),$("form .form-control").focus(function(){$(this).siblings("label").first().children("i").first().css({color:"#aaa",left:0})}),$("form .form-control").blur(function(){$(this).siblings("label").first().children("i").first().css({color:"transparent",left:"-20px"})});var n=$(".masonry-grid");n.imagesLoaded(function(){new AnimOnScroll(document.getElementById("grid"),{minDuration:.4,maxDuration:.7,viewportFactor:.2}),$("a.scroll").click(function(o){o.preventDefault();var i=$(this.hash).offset().top-t/2;$("html, body").animate({scrollTop:i},600)})}),google.maps.event.addDomListener(window,"load",i)});
